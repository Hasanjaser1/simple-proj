            ...
            <div class="content">
             ...
             @endif
                 ...
                 <div class="form-group">
                    <label for="exampleInputEmail1">{{__('message.Offer photo')}}</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name_en" value="{{$offer -> name_en}}" placeholder="{{__('message.Offer Name en')}}">
                    @error('name_en')
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                    ...
                    <input type="text" class="form-control" name="name_ar" value="{{$offer -> name_ar}}" placeholder="{{__('message.Offer Name ar')}}">
                    @error('name_ar')
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                  ...
                  <div class="form-group">
                   ...
                   <input type="text" class="form-control" name="price" value="{{$offer -> price}}" placeholder="{{__('message.Offer Price')}}">
                   @error('price')
                    <small class="form-text text-danger" >{{$message}}</small>
                    @enderror
                 </div>
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control" name="details_en" value="{{$offer -> details_en}}" placeholder="{{__('message.Offer Details en')}}">
                   @error('details_en')
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                   ...
                   <input type="text" class="form-control" name="details_ar" value="{{$offer -> details_ar}}" placeholder="{{__('message.Offer Details ar')}}">
                   @error('details_ar')
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                 </div>
