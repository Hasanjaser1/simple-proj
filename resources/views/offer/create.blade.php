             ...
             @endif
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name_en" placeholder="{{__('message.Offer Name en')}}">
                    @error('name_en')
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                    ...
                    <input type="text" class="form-control" name="name_ar" placeholder="{{__('message.Offer Name ar')}}">
                    @error('name_ar')
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                  ...
                  <div class="form-group">
                   ...
                   <input type="text" class="form-control" name="price" placeholder="{{__('message.Offer Price')}}">
                   @error('price')
                    <small class="form-text text-danger" >{{$message}}</small>
                    @enderror
                 </div>
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control" name="details_en" placeholder="{{__('message.Offer Details en')}}">
                   @error('details_en')
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                   ...
                   <input type="text" class="form-control" name="details_ar" placeholder="{{__('message.Offer Details ar')}}">
                   @error('details_ar')
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                 </div>
